...
async function updateUserProfile(details) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyAqNA5ClPBgJeYQk3i4zj5fu95sP7Wvvmw`;
...
async function getUserProfile(idToken , ctx) {
    const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyAqNA5ClPBgJeYQk3i4zj5fu95sP7Wvvmw`;
...
async function verifyEmail(idToken){
    const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyAqNA5ClPBgJeYQk3i4zj5fu95sP7Wvvmw`;
