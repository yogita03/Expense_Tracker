...
async function signUp(signupData, isLogIn , Actions ) {
  let url =
    "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAqNA5ClPBgJeYQk3i4zj5fu95sP7Wvvmw";
  if (isLogIn) {
    url =
      "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAqNA5ClPBgJeYQk3i4zj5fu95sP7Wvvmw";
  }
  try {
